...
import NewCustomModal from '../Headers/CustomModal/CustomModal'
...
export default function DisplayPdf({
  ...
  useEffect(() => {
    const updateWidth = () => {
      if (containerRef.current) {
        ...
        const clamped = Math.max(300, Math.min(500, containerWidth))
        setWidth(clamped)
      }
    }
  ...
  return (
    <>
      <NewCustomModal openModal={openModal} setOpenModal={setOpenModal}>
        <div
          ref={containerRef}
