...
export default function Banner() {
  return (
    <div className="w-11/12 p-10 relative mx-auto overflow-hidden bg-[#1B86CB]/20 my-16 max-w-[1280px] text-white min-h-[320px] rounded-lg">
      <CalendarOff className="absolute right-0 bottom-0 -my-14 w-96 h-96 stroke-[#1B86CB]/20 lg:stroke-[#1B86CB]/80" />
      <div>
