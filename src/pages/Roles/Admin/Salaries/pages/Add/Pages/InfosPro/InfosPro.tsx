  ...
  return (
    <FormProvider {...methods}>
      <form
        ...
        <div className="grid grid-cols-1 items-start lg:grid-cols-2 bg-white p-7 gap-x-8 gap-y-4 rounded-md border border-gray-200 shadow-md w-full">
        ...
        {/* Contact d'urgence */}
        <div className="grid grid-cols-1 items-start lg:grid-cols-2 p-7 bg-white gap-x-8 gap-y-4 rounded-md border border-gray-200 shadow-md w-full">
          <span className="text-xl col-span-1 lg:col-span-2 w-full basis-2 font-medium inline-block text-blue-600">
            Contact d'urgence :
          </span>
          {/* Nom complet */}
