...
export default function Banner() {
  return (
    <div className="w-11/12 p-8 lg:p-10 relative mx-auto overflow-hidden bg-[#2A9D8F]/20 my-16 max-w-[1280px] text-white min-h-[320px] rounded-lg">
      <Lock className="absolute right-0 bottom-0 -m-14 w-96 h-96 stroke-[#2A9D8F]/20 lg:stroke-[#2A9D8F]/80" />
      <div>
