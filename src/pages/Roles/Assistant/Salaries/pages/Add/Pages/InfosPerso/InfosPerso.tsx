  ...
  return (
    <FormProvider {...methods}>
      <form
        ...
        {/* identité */}
        <div className="grid grid-cols-1 items-start lg:grid-cols-2 p-7 gap-x-8 gap-y-4 rounded-md border border-gray-200 shadow-md w-full bg-white">
          ...
          <ControlledInput
            name="id"
            label="ID salarié KeyCloak"
            placeholder="Entrer un ID"
            register={register}
            error={errors.id}
            rules={{ required: true }}
            inputType="text"
            inputDefaultValue={employeePersonalInfo.id}
          />
          {/* civilité */}
          <ControlledSelect
            name="civilite"
