      ...
      <form
        ...
        <div className="flex flex-col items-center justify-around w-full gap-4 mt-10 mb-6 md:flex-row md:justify-center md:gap-10">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-2/3 disabled:cursor-not-allowed disabled:opacity-30 py-2 text-sm text-white border rounded md:w-1/3 lg:w-48 md:text-base border-blue-500 bg-blue-500">
