...
export default function ProfileBanner({ setActiveUploadAvatarModal }: IProps) {
  ...
  return (
    <div className="bg-black md:sticky md:top-36 rounded-md border border-gray-300 flex flex-col items-center justify-center p-8">
      {/* avatar */}
      ...
      {isPersonalInfo && (
        <button
          ...
          className=" bg-white mt-16 text-sm font-medium text-black px-8 py-3.5 rounded hover:scale-105 transition-all ease-in-out delay-75">
