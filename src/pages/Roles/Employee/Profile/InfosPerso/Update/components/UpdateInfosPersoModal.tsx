...
export default function UpdateInfosPersoModal({
  ...
  const UpdateAbsence = async () => {
    ...
    try {
      ...
      if (data) {
        formData.append('emailPersonnel', data.email_perso)
        formData.append('emailProfessionnel', data.email_pro)
        formData.append('telephonePersonnel', data.tel_perso)
        formData.append('telephoneProfessionnel', data.tel_pro)
        // adresse
        formData.append('adresse[pays]', data.pays)
        formData.append('adresse[codePostal]', data.code_postal)
        formData.append('adresse[ville]', data.ville)
        formData.append('adresse[adresse]', data.adresse)
      ...
      notify({
        message: 'Informations personnelles modifier avec success',
        type: 'success',
      })
